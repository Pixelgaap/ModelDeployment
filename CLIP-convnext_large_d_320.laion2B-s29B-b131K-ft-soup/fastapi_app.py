...
app = FastAPI(title='CLIP-convnext_large_d_320_laion2B-s29B-b131K-ft-soup API', version="1.0.0", description='FastAPI service for zero-shot-image-classification.')
