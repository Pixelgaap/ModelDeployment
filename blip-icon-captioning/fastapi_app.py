...
app = FastAPI(title="blip-icon-captioning API", version="1.0.0", description="FastAPI service for image captioning.")
...
@app.post("/caption", response_model=InferenceResponse)
