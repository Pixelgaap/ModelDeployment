...
app = FastAPI(title="mmBERT-base API", version="1.0.0", description="FastAPI service for masked-token prediction.")
...
@app.post("/fill-mask", response_model=InferenceResponse)
