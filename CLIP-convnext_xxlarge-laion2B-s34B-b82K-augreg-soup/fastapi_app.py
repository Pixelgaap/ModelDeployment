...
app = FastAPI(title='CLIP-convnext_xxlarge-laion2B-s34B-b82K-augreg-soup API', version="1.0.0", description='FastAPI service for zero-shot-image-classification.')
